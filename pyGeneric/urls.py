...
from .views import ProductoListView, ProductoCreateView, ProductoUpdateView, MovimientoCreateView, CategoriaCreateView, CategoriaListView, ProductoDeleteView
urlpatterns = [
